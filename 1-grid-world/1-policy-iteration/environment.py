...
class GraphicDisplay(tk.Tk):
    ...
    def load_images(self):
        ...
        rectangle = PhotoImage(Image.open("C:/Users/ljhlj/OneDrive/문서/GitHub/reinforcement-learning-kr-v2/1-grid-world/img/rectangle.png").resize((65, 65)))
        triangle = PhotoImage(Image.open("C:/Users/ljhlj/OneDrive/문서/GitHub/reinforcement-learning-kr-v2/1-grid-world/img/triangle.png").resize((65, 65)))
